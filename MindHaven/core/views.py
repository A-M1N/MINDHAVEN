        ...
        try:
            ...
            for post in posts_cursor:
                ...
                post_data = {
                    ...
                    "author_name": "Anonymous" if post.get("is_anonymous") else author_name,
...
def user_profile(request):
    if request.method == 'GET':
        try:
            ...
            user = Users.find_by_id('current_user_id')  # Replace 'current_user_id' with actual user identification logic
        ...
        try:
            ...
            if Users.verify_password(user, password):
                ...
                return JsonResponse({
                    ...
                    'user_id': str(user['_id'])  # MongoDB's _id should be converted to string
                }, status=200)
            else:
